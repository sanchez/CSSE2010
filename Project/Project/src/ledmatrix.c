...
uint8_t LEDMATRIX_LETTER_A[] = {126, 144, 144, 127};
uint8_t LEDMATRIX_LETTER_B[] = {254, 146, 146, 109};
uint8_t LEDMATRIX_LETTER_C[] = {124, 130, 130, 69};
uint8_t LEDMATRIX_LETTER_D[] = {254, 130, 130, 125};
uint8_t LEDMATRIX_LETTER_E[] = {254, 146, 146, 131};
uint8_t LEDMATRIX_LETTER_F[] = {254, 144, 144, 129};
uint8_t LEDMATRIX_LETTER_G[] = {124, 130, 146, 93};
uint8_t LEDMATRIX_LETTER_H[] = {254, 16, 16, 255};
uint8_t LEDMATRIX_LETTER_I[] = {130, 254, 131};
uint8_t LEDMATRIX_LETTER_J[] = {4, 2, 2, 253};
uint8_t LEDMATRIX_LETTER_K[] = {254, 16, 40, 199};
uint8_t LEDMATRIX_LETTER_L[] = {254, 2, 2, 3};
uint8_t LEDMATRIX_LETTER_M[] = {254, 64, 48, 64, 255};
uint8_t LEDMATRIX_LETTER_N[] = {254, 32, 16, 255};
uint8_t LEDMATRIX_LETTER_O[] = {124, 130, 130, 125};
uint8_t LEDMATRIX_LETTER_P[] = {254, 144, 144, 97};
uint8_t LEDMATRIX_LETTER_Q[] = {124, 130, 138, 124, 3};
uint8_t LEDMATRIX_LETTER_R[] = {254, 144, 152, 103};
uint8_t LEDMATRIX_LETTER_S[] = {100, 146, 146, 77};
uint8_t LEDMATRIX_LETTER_T[] = {128, 128, 254, 128, 129};
uint8_t LEDMATRIX_LETTER_U[] = {252, 2, 2, 253};
uint8_t LEDMATRIX_LETTER_V[] = {248, 4, 2, 4, 249};
uint8_t LEDMATRIX_LETTER_W[] = {252, 2, 28, 2, 253};
uint8_t LEDMATRIX_LETTER_X[] = {198, 40, 16, 40, 199};
uint8_t LEDMATRIX_LETTER_Y[] = {224, 16, 14, 16, 225};
uint8_t LEDMATRIX_LETTER_Z[] = {134, 138, 146, 162, 195};
uint8_t LEDMATRIX_LETTER_0[] = {124, 146, 162, 125};
uint8_t LEDMATRIX_LETTER_1[] = {66, 254, 3};
uint8_t LEDMATRIX_LETTER_2[] = {70, 138, 146, 99};
uint8_t LEDMATRIX_LETTER_3[] = {68, 146, 146, 109};
uint8_t LEDMATRIX_LETTER_4[] = {24, 40, 72, 255};
uint8_t LEDMATRIX_LETTER_5[] = {228, 162, 162, 157};
uint8_t LEDMATRIX_LETTER_6[] = {124, 146, 146, 77};
uint8_t LEDMATRIX_LETTER_7[] = {128, 158, 160, 193};
uint8_t LEDMATRIX_LETTER_8[] = {108, 146, 146, 109};
uint8_t LEDMATRIX_LETTER_9[] = {100, 146, 146, 125};
uint8_t LEDMATRIX_LETTER_SPACE[] = {0, 0, 1};

uint8_t* LEDMATRIX_LETTERS[] = { LEDMATRIX_LETTER_A, LEDMATRIX_LETTER_B, LEDMATRIX_LETTER_C, LEDMATRIX_LETTER_D, LEDMATRIX_LETTER_E, LEDMATRIX_LETTER_F, LEDMATRIX_LETTER_G, LEDMATRIX_LETTER_H, LEDMATRIX_LETTER_I, LEDMATRIX_LETTER_J, LEDMATRIX_LETTER_K, LEDMATRIX_LETTER_L, LEDMATRIX_LETTER_M, LEDMATRIX_LETTER_N, LEDMATRIX_LETTER_O, LEDMATRIX_LETTER_P, LEDMATRIX_LETTER_Q, LEDMATRIX_LETTER_R, LEDMATRIX_LETTER_S, LEDMATRIX_LETTER_T, LEDMATRIX_LETTER_U, LEDMATRIX_LETTER_V, LEDMATRIX_LETTER_W, LEDMATRIX_LETTER_X, LEDMATRIX_LETTER_Y, LEDMATRIX_LETTER_Z };
uint8_t* LEDMATRIX_NUMBERS[] = { LEDMATRIX_LETTER_0, LEDMATRIX_LETTER_1, LEDMATRIX_LETTER_2, LEDMATRIX_LETTER_3, LEDMATRIX_LETTER_4, LEDMATRIX_LETTER_5, LEDMATRIX_LETTER_6, LEDMATRIX_LETTER_7, LEDMATRIX_LETTER_8, LEDMATRIX_LETTER_9 };
